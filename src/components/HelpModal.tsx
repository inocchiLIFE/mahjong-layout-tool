        ...
        <div className="help-content">
          ...
          <section className="help-section" id="help-efficiency">
            ...
            <div className="help-feature-list">
              ...
              <div><strong>14枚のとき</strong><span>各打牌後のシャンテン数・形・受け入れを比較できます。聴牌になる打牌は和了牌と残り枚数を表示します。受け入れ枚数順で並ぶため、候補をすばやく比べられます。パネルを幅620px以上へ広げると、打牌カードは自動で2列表示になります。</span></div>
