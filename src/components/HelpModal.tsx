        ...
        <div className="help-content">
          ...
          <section className="help-section" id="help-edit">
            ...
            <div className="help-grid">
              ...
              <article><strong>文字・図形・線</strong><p>挿入タブまたは左側の記号・文字から追加できます。ペン、マーカー、直線、曲線、矢印、長方形・丸・三角形・✕・波線を配置できます。文字入力中に範囲を選択して右クリックすると、その部分だけ色・サイズ・フォント・太字を変更できます。ホームの文字編集にある「B」では、文字全体または次に入力する文字を太字にできます。</p></article>
              <article><strong>マイ図形を登録する</strong><p>図形・線・文字・画像を選択して、ホームの「マイ図形に保存」を押します。名前と配置時の既定色を登録すると、挿入タブと左側の「マイ図形」から固定グループとして呼び出せます。登録ボタンを右クリックすると、名前・既定色の変更や削除ができます。</p></article>
          ...
          <section className="help-section" id="help-settings">
            ...
            <div className="help-feature-list">
              ...
              <div><strong>文字・図形の初期値</strong><span>フォント、文字サイズ、太字、文字色、図形・描画の色、線の太さを、次に追加する要素の初期値として設定できます。</span></div>
