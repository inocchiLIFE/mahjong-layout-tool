        ...
        <div className="help-content">
          ...
          <section className="help-section" id="help-edit">
            ...
            <div className="help-grid">
              ...
              <article><strong>右クリックメニュー</strong><p>選択した要素を右クリックすると、複製・コピー・貼り付け・回転・表裏・ロック・プロパティ編集・隠す・前面／背面移動などを行えます。空いている場所では文字・画像・線・図形（波線を含む）をその位置に追加したり、作業領域を設定したりできます。表示する項目は設定画面または右クリックメニューの設定から選べます。</p></article>
              <article><strong>隠す（非表示）</strong><p>選択した要素をホームタブの「隠す」または右クリックの「隠す」から、内容を黒塗りで隠せます。黒塗り部分をクリックまたはEnter／Spaceで表示し、表示後にもう一度クリックすると再び隠せます。隠した要素や文字部分は、そのままドラッグして移動できます。文字編集中に範囲を選択して書式メニューの▮を押すと、その範囲だけを同じように切り替えられます。</p></article>
