        ...
        <div className="help-content">
          ...
          <section className="help-section" id="help-edit">
            ...
            <div className="help-grid">
              ...
              <article><strong>牌の向き・理牌</strong><p>選択牌は表／裏を切り替え、90度回転できます。ホームタブの「理牌」で、選択した牌だけを種類・数字順に並べます。</p></article>
              <article><strong>文字・図形・線</strong><p>挿入タブまたは左側の記号・文字から追加できます。ペン、直線、曲線、矢印、長方形・丸・三角形・✕・波線は右クリックメニューからも配置できます。左側から図形をドラッグして置いた後は、自動で選択ツールに戻ります。</p></article>
