        ...
        <div className="help-content">
          ...
          <section className="help-section" id="help-edit">
            ...
            <div className="help-grid">
              ...
              <article><strong>スポイラー（非表示）</strong><p>選択した要素を右クリックして「スポイラーにする」を選ぶと、内容を黒塗りで隠せます。黒塗り部分をクリックまたはEnter／Spaceで表示し、表示後にもう一度クリックすると再び隠せます。文字編集中に範囲を選択して書式メニューの▮を押すと、その範囲だけを同じように切り替えられます。</p></article>
