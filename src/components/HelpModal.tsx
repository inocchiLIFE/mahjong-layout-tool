        ...
        <div className="help-content">
          ...
          <section className="help-section" id="help-edit">
            ...
            <div className="help-grid">
              ...
              <article><strong>右クリックメニュー</strong><p>選択した要素を右クリックすると、複製・コピー・貼り付け・回転・表裏・ロック・プロパティ編集・前面／背面移動などを行えます。空いている場所では文字・画像・線・図形（波線を含む）をその位置に追加したり、作業領域を設定したりできます。表示する項目は設定画面または右クリックメニューの設定から選べます。</p></article>
