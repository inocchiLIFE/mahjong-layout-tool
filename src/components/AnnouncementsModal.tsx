...
const announcements = [
  { date: '2026年8月30日 22:35', title: 'スポイラー表示に対応', text: '選択した文字の範囲や配置した要素を黒塗りで非表示にし、クリックまたはEnter／Spaceで表示できるようになりました。表示後にもう一度クリックすると再び隠せます。文字の範囲は書式メニュー、要素全体は右クリックメニューから設定できます。' },
